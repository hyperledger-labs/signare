...
type AdminUserDetail struct {
	...
	Spec *AdminUserDetailSpec `json:"spec"`
}

// ValidateWith check whether AdminUserDetail is valid
func (data AdminUserDetail) ValidateWith() (*httpinfra.ValidationResult, *httpinfra.HTTPError) {
	if data.Meta == nil {
...
func (data *AdminUserDetail) SetDefaults() {
