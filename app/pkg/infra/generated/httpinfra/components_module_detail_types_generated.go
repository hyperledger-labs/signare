...
// ValidateWith check whether ModuleDetail is valid
func (data ModuleDetail) ValidateWith() (*httpinfra.ValidationResult, *httpinfra.HTTPError) {
	if data.Meta == nil {
...
func (data *ModuleDetail) SetDefaults() {
