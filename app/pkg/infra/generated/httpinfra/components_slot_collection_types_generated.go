...
type SlotCollection struct {
	...
	// collection of slots for a given Hardware Security Module.
	Items *[]SlotDetail `json:"items"`
}

// ValidateWith check whether SlotCollection is valid
func (data SlotCollection) ValidateWith() (*httpinfra.ValidationResult, *httpinfra.HTTPError) {
	if data.Limit == nil {
...
func (data *SlotCollection) SetDefaults() {
}
