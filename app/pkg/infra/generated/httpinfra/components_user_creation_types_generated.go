...
type UserCreation struct {
	...
	Spec *UserCreationSpec     `json:"spec"`
}

// ValidateWith check whether UserCreation is valid
func (data UserCreation) ValidateWith() (*httpinfra.ValidationResult, *httpinfra.HTTPError) {
	if data.Meta != nil {
...
func (data *UserCreation) SetDefaults() {
	if data.Meta != nil {
