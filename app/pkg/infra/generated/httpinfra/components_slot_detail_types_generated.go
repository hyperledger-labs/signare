...
type SlotDetail struct {
	...
	Spec *SlotDetailSpec     `json:"spec"`
}

// ValidateWith check whether SlotDetail is valid
func (data SlotDetail) ValidateWith() (*httpinfra.ValidationResult, *httpinfra.HTTPError) {
	if data.Meta == nil {
...
func (data *SlotDetail) SetDefaults() {
