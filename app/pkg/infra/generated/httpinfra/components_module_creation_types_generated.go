...
// ValidateWith check whether ModuleCreation is valid
func (data ModuleCreation) ValidateWith() (*httpinfra.ValidationResult, *httpinfra.HTTPError) {
	if data.Meta != nil {
...
func (data *ModuleCreation) SetDefaults() {
	if data.Meta != nil {
