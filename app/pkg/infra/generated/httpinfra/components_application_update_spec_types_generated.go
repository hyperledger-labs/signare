...
// ValidateWith check whether ApplicationUpdateSpec is valid
func (data ApplicationUpdateSpec) ValidateWith() (*httpinfra.ValidationResult, *httpinfra.HTTPError) {
	if data.ChainId == nil {
...
func (data *ApplicationUpdateSpec) SetDefaults() {
}
