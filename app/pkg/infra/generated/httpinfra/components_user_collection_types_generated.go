...
// ValidateWith check whether UserCollection is valid
func (data UserCollection) ValidateWith() (*httpinfra.ValidationResult, *httpinfra.HTTPError) {
	if data.Limit == nil {
...
func (data *UserCollection) SetDefaults() {
}
