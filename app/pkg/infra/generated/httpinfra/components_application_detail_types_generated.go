...
type ApplicationDetail struct {
	...
	Spec *ApplicationDetailSpec `json:"spec"`
}

// ValidateWith check whether ApplicationDetail is valid
func (data ApplicationDetail) ValidateWith() (*httpinfra.ValidationResult, *httpinfra.HTTPError) {
	if data.Meta == nil {
...
func (data *ApplicationDetail) SetDefaults() {
