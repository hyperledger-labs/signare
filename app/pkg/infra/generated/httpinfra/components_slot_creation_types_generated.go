...
type SlotCreation struct {
	...
	Spec *SlotCreationSpec     `json:"spec"`
}

// ValidateWith check whether SlotCreation is valid
func (data SlotCreation) ValidateWith() (*httpinfra.ValidationResult, *httpinfra.HTTPError) {
	if data.Meta != nil {
...
func (data *SlotCreation) SetDefaults() {
	if data.Meta != nil {
