...
type AdminUserCollection struct {
	...
	// collection of signer administrator users.
	Items *[]AdminUserDetail `json:"items"`
}

// ValidateWith check whether AdminUserCollection is valid
func (data AdminUserCollection) ValidateWith() (*httpinfra.ValidationResult, *httpinfra.HTTPError) {
	if data.Limit == nil {
...
func (data *AdminUserCollection) SetDefaults() {
}
