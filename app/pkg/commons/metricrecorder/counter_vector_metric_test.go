...
func TestDefaultCounter_Increase(t *testing.T) {
	...
	counter, err := metricRecorder.NewCounterVector("test_counter_name", []string{"test_counter_label_1", "test_counter_label_2"}, "")
	require.NoError(t, err)

	labels := map[string]string{
		"test_counter_label_1": "test_counter_label_1_value",
		"test_counter_label_2": "test_counter_label_2_value",
	}
	counter.Inc(labels)
